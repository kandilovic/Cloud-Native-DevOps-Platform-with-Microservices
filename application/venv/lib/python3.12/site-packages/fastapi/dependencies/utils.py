...
def get_dependant(
    *,
    ...
    for param_name, param in signature_params.items():
        ...
        if isinstance(
            param_details.field.field_info, (params.Body,
...
def _validate_value_with_model_field(
    *, field: ModelField, value: Any, values: Dict[str, Any], loc: Tuple[str, ...]
    ...
    if _is_error_wrapper(errors_):  # type: ignore[arg-type]
        ...
        new_errors = may_v1._regenerate_error_with_loc(
...
def _should_embed_body_fields(fields: List[ModelField]) -> bool:
    ...
    if (
        isinstance(first_field.field_info,
...
def get_body_field(
    *, flat_dependant: Dependant, name: str, embed_body_fields: bool
    ...
    if any(isinstance(f.field_info, params.File) for f in flat_dependant.body_params):
        ...
        BodyFieldInfo: Type[temp_pydantic_v1_params.Body] = temp_pydantic_v1_params.File
        ...
        BodyFieldInfo = temp_pydantic_v1_params.Form
    else:
        if annotation_is_pydantic_v1(BodyModel):
            # type: ignore[assignment]
            BodyFieldInfo = temp_pydantic_v1_params.Body
        else:
