        ...
        def __new__(cls, name, bases, ns, *, total=True, closed=None,
            ...
            if ns_annotations is not None:
                ...
                if hasattr(annotationlib, "get_annotate_from_class_namespace"):
                    own_annotate = annotationlib.get_annotate_from_class_namespace(
                        ns)
                else:
            ...
            if (closed and sys.version_info < (3, 14)
                ...
                annotation_type = own_checked_annotations.pop(
                    "__extra_items__")
            ...
            if sys.version_info >= (3, 14):
                def __annotate__(format):
                    ...
                    if own_annotate is not None:
                        ...
                        own = annotationlib.annotations_to_string(
                            own_annotations)
    ...
    def _collect_type_vars(types, typevar_types=None):
        ...
        for t in types:
            if _is_unpacked_typevartuple(t):
                ...
                isinstance(t, typevar_types) and not isinstance(
                    t, _UnpackAlias)
                and t not in tvars
            ):
...
if sys.version_info >= (3, 14):
    ...
    def get_annotations(obj, *, globals=None, locals=None, eval_str=False,
        ...
        * STRING: return annotations as strings, in a format close to the original
        ...
        return_value = {key:
                        value if not isinstance(value, str) else eval(
...
globals().update(
    {name: getattr(typing, name)
     for name in _typing_names if hasattr(typing, name)}
)
