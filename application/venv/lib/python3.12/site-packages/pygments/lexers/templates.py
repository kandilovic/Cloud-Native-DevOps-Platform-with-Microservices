...
class VelocityLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(#\{?)(' + identifier + r')(\}?)(\s?\()',
             bygroups(Comment.Preproc, Name.Function,
...
class HtmlDjangoLexer(DelegatingLexer):
    ...
    filenames = ['*.html.j2', '*.htm.j2', '*.xhtml.j2',
                 '*.html.jinja2', '*.htm.jinja2', '*.xhtml.jinja2']
    version_added = ''
    alias_filenames = ['*.html', '*.htm', '*.xhtml']
...
class YamlJinjaLexer(DelegatingLexer):
    ...
    filenames = ['*.sls', '*.yaml.j2', '*.yml.j2',
                 '*.yaml.jinja2', '*.yml.jinja2']
        ...
        'root': [
            ...
            (r'([([]+)([\w:.-]+)([\])]+)(\s*)(=)(\s*)',
             bygroups(Punctuation, Name.Attribute,
                      Punctuation, Text, Operator, Text),
             'attr'),
            (r'([([]+)([\w:.-]+)([\])]+)(\s*)',
