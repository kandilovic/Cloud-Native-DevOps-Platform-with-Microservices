...
class HaxeLexer(ExtendedRegexLexer):
    ...
    tokens = {
        ...
        'preproc-expr-in-parenthesis': [
            ...
            (r'[0-9]+\.[0-9]*[eE][+\-]?[0-9]+',
             Number.Float, ('#pop', 'preproc-expr-chain')),
        ...
        'macro': [
            ...
            (r'(?:extern|private)\b', Keyword.Declaration),
            (r'(?:abstract)\b', Keyword.Declaration,
             ('#pop', 'optional-semicolon', 'abstract')),
            (r'(?:class|interface)\b', Keyword.Declaration,
             ('#pop', 'optional-semicolon', 'macro-class')),
            (r'(?:enum)\b', Keyword.Declaration,
             ('#pop', 'optional-semicolon', 'enum')),
            (r'(?:typedef)\b', Keyword.Declaration,
        ...
        'var': [
            include('spaces'),
            (ident_no_keyword, Text, ('#pop', 'var-sep',
             'assign', 'flag', 'prop-get-set')),
        ],
        ...
        'bracket-check': [
            ...
            default(('#pop', 'block', 'optional-semicolon',
                    'expr-chain')),  # is block
        ],
