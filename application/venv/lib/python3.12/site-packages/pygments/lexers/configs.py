        ...
        'root': [
            ...
            (r'(body|bundle)(\s+)(\S+)(\s+)(\w+)(\()',
             bygroups(Keyword, Whitespace, Keyword,
                      Whitespace, Name.Function, Punctuation),
             'arglist'),
            (r'(body|bundle)(\s+)(\S+)(\s+)(\w+)',
...
class TerraformLexer(ExtendedRegexLexer):
    ...
    ip_network_functions = ('cidrhost', 'cidrnetmask',
...
class AugeasLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(let)(\s*)([^\s=]+)', bygroups(Keyword.Declaration,
    ...
    tokens = {
        'root': [
            ...
            (r'^([ ]*)([^\{\[\s].*?)(:)( )(.*?)([ \t]*)$', bygroups(Whitespace,
             Name.Tag, Punctuation, Whitespace, Text, Whitespace)),
        ],
        'inline_list': [
            include('whitespace'),
            (r'[^\{\}\[\],\s]+', Text),
